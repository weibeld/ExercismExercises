...
public final class HandshakeCalculatorTest {
    ...
    @Test
    public void testThatAdditionalBitsAreIgnored1() {
        assertEquals(
                singletonList(Signal.WINK),
                handshakeCalculator.calculateHandshake(33));
    }

    @Test
    public void testThatAdditionalBitsAreIgnored2() {
        assertEquals(
                asList(Signal.WINK, Signal.DOUBLE_BLINK),
                handshakeCalculator.calculateHandshake(1187));
    }
