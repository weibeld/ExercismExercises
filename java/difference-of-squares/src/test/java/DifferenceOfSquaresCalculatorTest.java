...
public final class DifferenceOfSquaresCalculatorTest {
    ...
    @Test
    public void testSquareOfSum0() {
        final int expected = 0;
        final int actual = calculator.computeSquareOfSumTo(0);
    ...
    @Test
    public void testSumOfSquares0() {
        final int expected = 0;
        final int actual = calculator.computeSumOfSquaresTo(0);
        assertEquals(expected, actual);
    }
    ...
    @Test
    public void testDifferenceOfSquaresMinus() {
        final int expected = 0;
        final int actual = calculator.computeDifferenceOfSquares(-3);
        assertEquals(expected, actual);
    }
